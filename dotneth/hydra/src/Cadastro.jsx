...
const Cadastro = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/users/register', { // Nova URL de endpoint para .NET
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                setMessage({ type: 'error', text: errorData.message || 'Erro no cadastro. Tente novamente.' });
            }
        } catch (error) {
